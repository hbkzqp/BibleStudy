...
namespace BibleStudy.DataLayer
{
    public abstract class SqlHelper
    {
        ...
        public static readonly string connectionString = System.Configuration.ConfigurationManager.ConnectionStrings["BibleDb"].ConnectionString.Trim();
        ...
        public static SqlParameter buildParameter(string name, object value)
        {
